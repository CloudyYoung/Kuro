...
return {
	...
	ANNOUNCE_CHARLIE = "Hello Charlie!",
	ANNOUNCE_CHARLIE_ATTACK = "OW! It's hurt Charlie!",
	ANNOUNCE_COLD = "So cold!",
	ANNOUNCE_HOT = "I'm burning!",
	ANNOUNCE_CRAFTING_FAIL = "I don't have all of the ingredients.",
	ANNOUNCE_DEERCLOPS = "It's big and fresh blood. Ready to play babe~",
	...
	ANNOUNCE_HUNGRY = "I need some blood....",
	ANNOUNCE_HUNT_BEAST_NEARBY = "It's here!",
	...
	ANNOUNCE_WETTER = "I should back to my ground! ",
	...
	BATTLECRY =
	{
		GENERIC = "Your blood will be mine!",
		PIG = "Too fat!",
		PREY = "Too small!",
		SPIDER = "Stupid!",
		SPIDER_WARRIOR = "I hate yellow!",
	},
	COMBAT_QUIT =
	{
